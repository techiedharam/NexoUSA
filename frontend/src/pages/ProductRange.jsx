...
import productRanegBanner from "../assets/img/productRanegBanner.jpg"
import ThreadedRodsProducersIndia from "../assets/img/Threaded-Rods-Producers-India.jpg"
const ProductRange = () => {
  const fastenersData = [
  ...
  return (
    ...
    <div>
      <div> {/* banner image  */}
        <img src={productRanegBanner} alt="" className=" w-full h-[250px] bg-no-repeat bg-full bg-center bg-fixed" />
      ...
      <div className="w-[70%] m-auto mt-5"> {/* Range of Commercial & Precision Fasteners Table Container*/}
        ...
        <div className="flex flex-col md:flex-row justify-between w-full p-4">
          ...
          <div className="w-full md:w-[48%]">
            ...
            <img src={ThreadedRodsProducersIndia} alt="" />
          </div>
        </div>
