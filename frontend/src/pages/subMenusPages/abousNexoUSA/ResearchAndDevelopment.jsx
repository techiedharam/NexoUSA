...
import banner2 from "../../../assets/aboutNexoImg/banner2.jpeg";
import GalvanizedCarbonSteelFasteners from "../../../assets/aboutNexoImg/Galvanized-Carbon-Steel-Fasteners.png";
  ...
  return (
    <div>
      ...
      <div className="flex flex-col lg:flex-row gap-5 px-4 md:px-10 lg:px-20 py-5">
        ...
        <div className="lg:w-[75%] text-justify">
          <p className="text-sm md:text-base leading-relaxed">
            ...
            organization. We are keeping abreast with the latest state-of-the-art
            technologies.
            <br />
            <br />
        ...
        <div className="lg:w-[25%] flex justify-center">
          <img
            src={GalvanizedCarbonSteelFasteners}
      ...
      <div className="px-4 md:px-10 lg:px-20 text-justify text-sm md:text-base leading-relaxed">
        <p>
          After establishing our brand name in the field of industrial
          fasteners worldwide, Nexo has extended into the fabrication and
          galvanization of tower material and has installed state-of-the-art
          infrastructure and testing equipment for top-class services.
        </p>
        <br />
        <p>
          We think that the success of any enterprise, especially in these
          highly competitive times, relies on employing the best minds and
          most qualified hands. These individuals must possess the vision and
          ...
          the most competent individuals in their respective fields and
          provided environmentally sound facilities to perform perfectly.
        </p>
        <br />
        <p>
