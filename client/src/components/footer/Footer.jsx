  ...
  return (
    ...
    >
      ...
      <div className=" grid lg:grid-cols-3 grid-cols-1 gap-5 text-white">
        <div>
          <h1 className=" text-xl text-[#fff] underline font-semibold ">ABOUS US</h1>
        ...
        <div>
          <h1 className="text-xl text-[#fff] underline font-semibold">GET IN TOUCH</h1>
        ...
        <div>
          <h1 className=" text-xl text-[#fff] underline font-semibold">LOCATE US</h1>
